        ...
        <transition name="yb-confirm-fade">
            <div class="yb-confirm" @click.stop="contentClick" v-show="visible">
                ...
                <div class="yb-confirm-content">
                    <div
                        style="box-sizing:border-box;:100%;padding:0 20px;display:flex;align-items:center"
                    >
                        <label
                            style="font-size: 20px;font-weight: 900;margin-right: 15px;"
                        >Password:</label>
                        <ElInput v-model="password" @keydown.enter="confirm()"></ElInput>
                    </div>
                </div>
